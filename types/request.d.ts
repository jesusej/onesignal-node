declare module '@cypress/request' {
  // Type definitions for @cypress/request based on typings of request 2.48
  // Project: https://github.com/cypress-io/request
  // Original project: https://github.com/request/request
  // Original definitions by: Carlos Ballesteros Velasco <https://github.com/soywiz>,
  ...
  // Originally imported from: https://github.com/soywiz/typescript-node-definitions/d.ts
